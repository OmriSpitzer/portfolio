...
const SectionBackground = ({ id }) => {
    ...
    return (
        <div className="pointer-events-none absolute inset-0">
            {isMainPage ?
                <>
                    <div className={`absolute rounded-full animate-blob-out
                            ${isMobile ?
                    ...
                    />
                    <div
                        className={`absolute rounded-full animate-blob-in ${color2} ${isMobile
                ...
                (sectionIndex % 2 === 0 ?
                    <>
                        <div
                            className={`absolute rounded-full animate-blob-out ${color1}
                            ${isMobile
                                    ? '-right-8 top-0 h-56 w-56 blur-2xl'
                                    : '-right-24 top-1/8 h-96 w-96 blur-3xl'
                                }`}
                        />
                        <div
                            className={`absolute rounded-full animate-blob-in ${color2}
                            ${isMobile
                        ...
                        />
                        <div
                            className={`absolute rounded-full animate-blob-out ${color2}
                            ${isMobile
                    ...
                    <>
                        <div
                            className={`absolute rounded-full animate-blob-in ${color1}
                            ${isMobile
                                    ? '-left-12 bottom-1/3 h-56 w-56 -translate-y-1/2 blur-2xl'
                                    : '-left-20 top-1/3 h-100 w-100 -translate-y-1/2 blur-[90px]'
                                }`}
                        />
                        <div
                            className={`absolute rounded-full animate-blob-out ${color2}
                            ${isMobile
                                    ...
                                    : 'right-0 bottom-1/4 h-120 w-120 translate-x-1/4 blur-3xl'
                                }`}
                        />
                        <div
                            className={`absolute rounded-full animate-blob-in ${color1}
